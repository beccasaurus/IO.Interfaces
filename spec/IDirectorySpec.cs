...
namespace IO.Interfaces.Specs {
	...
	public class IDirectorySpec : Spec {
		...
		public void Directories() {
			new Implementations.RealDirectory(PathToTemp("base")).Directories().ToStrings().ShouldEqual(new List<string>{
				PathToTemp("base/dir"),
				PathToTemp("base/other"),
				PathToTemp("base/other/dir"),
			});
			new Implementations.RealDirectory(PathToTemp("base")).Dirs().ToStrings().ShouldEqual(new List<string>{
				PathToTemp("base/dir"),
				PathToTemp("base/other"),
				PathToTemp("base/other/dir"),
			});
